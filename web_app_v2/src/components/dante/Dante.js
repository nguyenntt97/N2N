...
var updateDataOfBlock = function updateDataOfBlock(
  editorState,
  block,
  newData
) {
    ...
    _createClass(Link, [
      {
        ...
        value: function render() {
          this.data = this.props.contentState
            ...
            .getData(); //Entity.get(this.props.entityKey).getData()
...
var Debug =
  ...
  (function(_React$Component) {
    ...
    function Debug() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (Debug.__proto__ || Object.getPrototypeOf(Debug)).call(this)
      );
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("h2", null, "EDITOR OUTPUT"),
...
var findEntities = function findEntities(
  entityType,
  instance,
  contentBlock,
  callback
        ...
        return (
          ...
          res
            ? ((opts = {
              ...
              contentState.mergeEntityData(entityKey, opts))
            : void 0,
          res
        );
      };
    ...
    _createClass(SaveBehavior, [
      ...
      },
      {
        ...
        value: function checkforStore(content) {
          // ENTER DATA STORE
          var isChanged = !Immutable__default.is(
            Immutable__default.fromJS(this.editorContent),
            Immutable__default.fromJS(content)
...
var customHTML2Content = function customHTML2Content(HTML, blockRn) {
  ...
  var content = draftJs.convertFromHTML(
    tempDoc.body.innerHTML,
    draftJs.getSafeBodyFromHTML,
    blockRn
  );
...
var DanteEditor =
  ...
  (function(_React$Component) {
    ...
    function DanteEditor(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (DanteEditor.__proto__ || Object.getPrototypeOf(DanteEditor)).call(
          this,
          props
        )
      );
      ...
      _defineProperty(
        ...
        function() {
          ...
          if (_this.props.content) {
            newEditorState = draftJs.EditorState.set(
              _this.decodeEditorContent(_this.props.content),
              {
      ...
      _defineProperty(
        ...
        function(newEditorState) {
          ...
          var selectionState = draftJs.SelectionState.createEmpty(
            s.getAnchorKey()
          ...
          var newState = draftJs.EditorState.forceSelection(
            newEditorState,
            selectionState
          );
      ...
      _defineProperty(_assertThisInitialized(_this), "forceRender", function(
        ...
        var content = editorState.getCurrentContent();
        var newEditorState = draftJs.EditorState.createWithContent(
          content,
          _this.decorator
        );
      ...
      _defineProperty(
        ...
        function(editorState) {
          ...
          var undeletable_types = _this.props.widgets
            .filter(function(o) {
          ...
          if (undeletable_types.length > 0 && undeletablesMap.size === 0) {
            ...
            return (editorState = draftJs.EditorState.push(
              editorState,
              newContentState,
              "change-block"
            ));
      ...
      _defineProperty(_assertThisInitialized(_this), "emitHTML2", function() {
        return draftConvert.convertToHTML({
          entityToHTML: function entityToHTML(entity, originalText) {
            if (entity.type === "LINK") {
              return '<a href="'
                .concat(entity.data.url, '">')
                .concat(originalText, "</a>");
            } else {
              return originalText;
            }
          }
      ...
      _defineProperty(
        ...
        "defaultWrappers",
        function(blockType) {
          return _this.props.default_wrappers
            .filter(function(o) {
      ...
      _defineProperty(_assertThisInitialized(_this), "blockRenderer", function(
        block
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "blockStyleFn", function(
        block
      ) {
        var currentBlock = getCurrentBlock(_this.state.editorState);
      ...
      _defineProperty(_assertThisInitialized(_this), "getDataBlock", function(
        block
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "styleForBlock", function(
        block,
        currentBlock,
        is_selected
      ) {
        ...
        var selectedFn = dataBlock.selectedFn
          ? dataBlock.selectedFn(block)
          : "";
        var selected_class = dataBlock.selected_class
          ? dataBlock.selected_class
          : "";
        var selected_class_out = is_selected ? selected_class : "";
        return ""
          .concat(dataBlock.wrapper_class, " ")
          .concat(selected_class_out, " ")
          .concat(selectedFn);
      });

      _defineProperty(
        _assertThisInitialized(_this),
        "handleTooltipDisplayOn",
        function(prop, display) {
      ...
      */
      ...
      _defineProperty(_assertThisInitialized(_this), "handleTXTPaste", function(
        text,
        html
      ) {
        var currentBlock = getCurrentBlock(_this.state.editorState);
        ...
        switch (currentBlock.getType()) {
          ...
          case "placeholder":
            ...
            editorState = draftJs.EditorState.push(
              editorState,
              newContent,
              "replace-text"
            );
      ...
      _defineProperty(
        ...
        function(text, html) {
          ...
          var newContentState = customHTML2Content(
            html,
            _this.extendedBlockRenderMap
          );
          ...
          var pushedContentState = draftJs.EditorState.push(
        ...
        function(files) {
          ...
          return files.map(function(file) {
            ...
            return _this.onChange(
              addNewBlock(_this.state.editorState, "image", opts)
            );
          });
        }
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "handleUpArrow", function(
        e
      ) {
        return setTimeout(function() {
      ...
      _defineProperty(_assertThisInitialized(_this), "handleReturn", function(
        e
      ) {
        ...
        if (!e.altKey && !e.metaKey && !e.ctrlKey) {
          ...
          if (currentBlock.getText().length === 0) {
            if (config_block && config_block.handleEnterWithoutText) {
              config_block.handleEnterWithoutText(
                _assertThisInitialized(_this),
                currentBlock
              );
          ...
          if (currentBlock.getText().length > 0) {
            if (config_block && config_block.handleEnterWithText) {
              config_block.handleEnterWithText(
                _assertThisInitialized(_this),
                currentBlock
              );
      ...
      _defineProperty(
        ...
        function(chars) {
          ...
          var afterEndEntityType =
            afterEndKey && draftJs.Entity.get(afterEndKey).getType(); // will insert blank space when link found
          ...
          if (
            ...
            var newContentState = draftJs.Modifier.insertText(
              editorState.getCurrentContent(),
              selection,
              " "
            );
            var newEditorState = draftJs.EditorState.push(
              editorState,
              newContentState,
              "insert-characters"
            );
          ...
          var blockTo =
            _this.props.character_convert_mapping[
      ...
      _defineProperty(
        ...
        function(command) {
          ...
          if (
            _this.props.handleKeyCommand &&
            _this.props.handleKeyCommand(command)
          ) {
            return true;
          }
          ...
          if (command.indexOf("toggle_inline:") === 0) {
            ...
            _this.onChange(
              draftJs.RichUtils.toggleInlineStyle(editorState, newBlockType)
            );
          ...
          if (command.indexOf("toggle_block:") === 0) {
            ...
            _this.onChange(
              draftJs.RichUtils.toggleBlockType(editorState, newBlockType)
            );

            return true;
          }

          var newState = draftJs.RichUtils.handleKeyCommand(
            _this.state.editorState,
            command
          );
      ...
      _defineProperty(_assertThisInitialized(_this), "findCommandKey", function(
        opt,
        command
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "KeyBindingFn", function(
        e
      ) {
        //⌘ + B / Ctrl + B   Bold
        //⌘ + I / Ctrl + I   Italic
        ...
        if (e.which == 13) {
          cmd = _this.findCommandKey("enter", e.which);

          if (cmd) {
            _this.save.save(_this.emitSerializedOutput());
            return "handled";
          }
      ...
      _defineProperty(
        ...
        function(block, options) {
          ...
          var newState = updateDataOfBlock(
            _this.state.editorState,
            block,
            newData
      ...
      _defineProperty(_assertThisInitialized(_this), "setDirection", function(
        direction_type
      ) {
      ...
      _this.extendedBlockRenderMap = draftJs.DefaultDraftBlockRenderMap.merge(
...
function imageLeft() {
  return React.createElement(
    ...
    React.createElement("path", {
      fill: "#fff",
      d:
        "M8 26h28v3h-28v-3zM24 20h12v3h-12v-3zM0 8h21v15h-21v-15zM24 14h12v3h-12v-3zM24 8h12v3h-12v-3zM8 2h28v3h-28v-3z"
    })
  );
}
function imageWide() {
...
function video() {
  return React.createElement(
    ...
    React.createElement("path", {
      ...
      fillRule: "nonzero",
      d:
        "M6.5,4 L6.5,15.5471358 L16.5,9.7735679 L6.5,4 Z M7.2945422,5.375733 L14.9109157,9.7735679 L7.2945422,14.1714028 L7.2945422,5.375733 Z",
      id: "Shape"
    })
  );
}
function divider() {
  return React.createElement(
    ...
    React.createElement("path", {
      fill: "#494B56",
      d:
        "M3,10 L4,10 L4,11 L3,11 L3,10 Z M5,10 L6,10 L6,11 L5,11 L5,10 Z M7,10 L8,10 L8,11 L7,11 L7,10 Z M9,10 L10,10 L10,11 L9,11 L9,10 Z M11,10 L12,10 L12,11 L11,11 L11,10 Z M13,10 L14,10 L14,11 L13,11 L13,10 Z M15,10 L16,10 L16,11 L15,11 L15,10 Z M17,10 L18,10 L18,11 L17,11 L17,10 Z"
    }),
...
function embed() {
  return React.createElement(
    ...
    React.createElement("path", {
      fill: "#494B56",
      d:
        "M13.0410996,14.8261802 C12.8030724,15.057835 12.4169249,15.0580448 12.1786821,14.8261802 C11.9404393,14.5943156 11.9406549,14.2185061 12.1786821,13.9868514 L16.275165,10.0000393 L12.1786821,6.01322731 C11.9404393,5.78136272 11.9404393,5.40576303 12.1786821,5.17389844 C12.4169249,4.94203385 12.8028568,4.94203385 13.0410996,5.17389844 L18,10.0000393 L13.0410996,14.8261802 Z"
    }),
    React.createElement("path", {
      fill: "#494B56",
      d:
        "M6.95890041,14.8261802 L2,10.0000393 L6.95890041,5.17389844 C7.19714323,4.94203385 7.58307507,4.94203385 7.82131789,5.17389844 C8.0595607,5.40576303 8.0595607,5.78136272 7.82131789,6.01322731 L3.72483495,10.0000393 L7.82131789,13.9868514 C8.05934511,14.2185061 8.0595607,14.5943156 7.82131789,14.8261802 C7.58307507,15.0580448 7.19692763,15.057835 6.95890041,14.8261802 Z"
    })
  );
} // TEXT TOOLTIP
...
function fontColor() {
  return React.createElement(
    ...
    React.createElement("path", {
      ...
      fillRule: "nonzero",
      d:
        "M8.12739586,9.73148148 L10.4359896,4.25925926 L10.2674515,3.85976152 L10.6775092,3.68676844 L10.8505023,3.27671076 L11.25,3.44524887 L11.6494977,3.27671076 L11.8224908,3.68676844 L12.2325485,3.85976152 L12.0640104,4.25925926 L14.3726041,9.73148148 L14.5,9.73148148 L14.5,10.0334569 L15.7325485,12.9550533 L14.3505023,13.5381041 L13.3773959,11.2314815 L9.12260414,11.2314815 L8.14949774,13.5381041 L6.7674515,12.9550533 L8,10.0334569 L8,9.73148148 L8.12739586,9.73148148 Z M9.75541664,9.73148148 L12.7445834,9.73148148 L11.25,6.18876537 L9.75541664,9.73148148 Z"
    }),
    React.createElement("path", {
      fill: "#07A8FF",
      d:
        "M14,15.9259259 L19,15.9259259 C19.5522847,15.9259259 20,16.3736412 20,16.9259259 L20,17 C20,17.5522847 19.5522847,18 19,18 L14,18 L14,15.9259259 Z"
    }),
    React.createElement("rect", {
      fill: "#FFCE0F",
      x: "8",
    ...
    React.createElement("path", {
      fill: "#FF2B64",
      d:
        "M3,15.9259259 L8,15.9259259 L8,18 L3,18 C2.44771525,18 2,17.5522847 2,17 L2,16.9259259 C2,16.3736412 2.44771525,15.9259259 3,15.9259259 Z"
    })
  );
}
function bold() {
...
function italic() {
  return React.createElement(
    ...
    React.createElement("polygon", {
      ...
      fill: "#B1B4C1",
      points:
        "11.5083008 5.08886719 13.2749023 5.08886719 10.5327148 18 8.76611326 18"
    })
  );
}
...
function code() {
  return React.createElement(
    ...
    React.createElement("path", {
      d:
        "M15.512,11.828 L5.236,15.916 L15.512,20.004 L15.512,23.196 L1.288,17.568 L1.288,14.264 L15.512,8.608 L15.512,11.828 Z M19.392,20.004 L29.668,15.916 L19.392,11.828 L19.392,8.608 L33.616,14.264 L33.616,17.568 L19.392,23.196 L19.392,20.004 Z",
      id: "<->",
      className: "icon-fillcolor",
      fill: "#B1B4C1"
    })
...
function h4() {
  return React.createElement(
    ...
    React.createElement("path", {
      d:
        "M0.932,5.008 L5.328,5.008 L5.328,12.68 L13.42,12.68 L13.42,5.008 L17.816,5.008 L17.816,25 L13.42,25 L13.42,16.376 L5.328,16.376 L5.328,25 L0.932,25 L0.932,5.008 Z M26.9474147,10.384 L26.8634147,10.384 L21.7954147,17.188 L26.9474147,17.188 L26.9474147,10.384 Z M26.9474147,20.464 L18.6594147,20.464 L18.6594147,16.824 L27.1714147,5.4 L30.7274147,5.4 L30.7274147,17.188 L33.3314147,17.188 L33.3314147,20.464 L30.7274147,20.464 L30.7274147,25 L26.9474147,25 L26.9474147,20.464 Z",
      id: "H4",
      className: "icon-fillcolor",
      fill: "#B1B4C1"
    })
  ...
  (function(_React$Component) {
    ...
    function DanteImagePopover(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (
          DanteImagePopover.__proto__ ||
          Object.getPrototypeOf(DanteImagePopover)
        ).call(this, props)
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "_toggleScaled", function(
        ev
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "relocate", function() {
        ...
        if (editorState.getSelection().isCollapsed()) {
          ...
          if (blockType === "image") {
            var imageBoxNode = document.getElementsByClassName(
              "is-selected"
            )[0];
            ...
            var left =
              ...
              toolbarWidth / 2; //let left = selectionRect.left + selectionRect.width / 2 - padd
      ...
      _defineProperty(_assertThisInitialized(_this), "render", function() {
        return React.createElement(
          ...
          {
            ref: "image_popover",
            className: "dante-popover popover--Aligntooltip popover--top popover--animated ".concat(
              _this.state.show ? "is-active" : undefined
            ),
            style: {
  ...
  (function(_React$Component2) {
    ...
    function DanteImagePopoverItem() {
      ...
      _this2 = _possibleConstructorReturn(
        this,
        (_ref =
          DanteImagePopoverItem.__proto__ ||
          Object.getPrototypeOf(DanteImagePopoverItem)).call.apply(
          _ref,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(_assertThisInitialized(_this2), "render", function() {
        return React.createElement(
          "li",
          {
            className: "dante-menu-button align-".concat(
              _this2.props.item.type
            ),
  ...
  (function(_React$Component) {
    ...
    function DanteAnchorPopover(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (
          DanteAnchorPopover.__proto__ ||
          Object.getPrototypeOf(DanteAnchorPopover)
        ).call(this, props)
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "relocate", function(
        ...
        var relativeParent = getRelativeParent(
          _this.refs.dante_popover.parentElement
        );
        ...
        value: function render() {
          ...
          return React.createElement(
            "div",
            {
              ref: "dante_popover",
              className:
                "dante-popover popover--tooltip popover--Linktooltip popover--bottom is-active",
              style: style,
  ...
  (function(_React$Component) {
    ...
    function DanteInlineTooltip(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (
          DanteInlineTooltip.__proto__ ||
          Object.getPrototypeOf(DanteInlineTooltip)
        ).call(this, props)
      );
      ...
      _defineProperty(
        ...
        function(input) {
          ...
          return _this.props.onChange(
            resetBlockWithType(_this.props.editorState, "placeholder", opts)
          );
        }
      );

      _defineProperty(_assertThisInitialized(_this), "insertImage", function(
        file
      ) {
        var opts = {
          url: URL.createObjectURL(file),
        ...
        return _this.props.onChange(
          addNewBlock(_this.props.editorState, "image", opts)
        );
      });
      ...
      */
      ...
      _defineProperty(
        ...
        function(e) {
          ...
          return _this.props.onChange(
            addNewBlock(_this.props.editorState, e.type, {})
          );
        }
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "clickHandler", function(
        ...
        switch (request_block.widget_options.insertion) {
          ...
          default:
            return console.log(
              "WRONG TYPE FOR ".concat(request_block.widget_options.insertion)
            );
        }
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "isDescendant", function(
        parent,
        child
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "relocate", function() {
        ...
        var relativeParent = getRelativeParent(
          _this.refs.tooltip.parentElement
        );
  ...
  (function(_React$Component2) {
    ...
    function InlineTooltipItem() {
      ...
      _this3 = _possibleConstructorReturn(
        this,
        (_ref =
          InlineTooltipItem.__proto__ ||
          Object.getPrototypeOf(InlineTooltipItem)).call.apply(
          _ref,
          [this].concat(args)
        )
      );

      _defineProperty(_assertThisInitialized(_this3), "clickHandler", function(
        e
      ) {
        e.preventDefault();
  ...
  (function(_React$Component) {
    ...
    function DanteTooltipColor() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_ref =
          DanteTooltipColor.__proto__ ||
          Object.getPrototypeOf(DanteTooltipColor)).call.apply(
          _ref,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(
        ...
        function() {
          ...
          if (!selection.isCollapsed()) {
            return _this.props.styles[_this.props.style_type].current(
...
var DanteTooltip =
  ...
  (function(_React$Component) {
    ...
    function DanteTooltip(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (DanteTooltip.__proto__ || Object.getPrototypeOf(DanteTooltip)).call(
          this,
          props
        )
      );
      ...
      _defineProperty(
        ...
        function(ev, style) {
          ...
          _this.props.onChange(
            draftJs.RichUtils.toggleInlineStyle(_this.props.editorState, style)
          );
      ...
      _defineProperty(_assertThisInitialized(_this), "relocate", function() {
        ...
        if (
          _this.props.configTooltip.selectionElements.indexOf(blockType) < 0
        ) {
          _this.hide();
        ...
        var relativeParent = getRelativeParent(
          _this.refs.dante_menu.parentElement
        );
      ...
      _defineProperty(
        ...
        function(ev, style) {
          ...
          _this.props.onChange(
            draftJs.RichUtils.toggleBlockType(_this.props.editorState, style)
          );
      ...
      _defineProperty(
        _assertThisInitialized(_this),
        "_clickBlockInlineStyle",
        function(ev, style) {
          var k = Object.keys(style)[0];

          _this.props.onChange(
            _this.props.styles[k].toggle(_this.props.editorState, style[k])
      ...
      _defineProperty(_assertThisInitialized(_this), "confirmLink", function(
        e
      ) {
        e.preventDefault();
        var editorState = _this.props.editorState;
        ...
        _this.props.onChange(
          draftJs.RichUtils.toggleLink(editorState, selection, entityKey)
        );
          ...
          return currentBlock.findEntityRanges(
            ...
            function(start, end) {
              ...
              if (start === selStart && end === selEnd) {
                defaultUrl = contentState.getEntity(selectedEntity).getData()
                  .url;
      ...
      _defineProperty(_assertThisInitialized(_this), "render", function() {
        return React.createElement(
          "div",
          {
            id: "dante-menu",
            ref: "dante_menu",
            className: "dante-menu "
              .concat(_this.displayActiveMenu(), " ")
              .concat(_this.displayLinkMode()),
  ...
  (function(_React$Component2) {
    ...
    function DanteTooltipItem() {
      ...
      _this2 = _possibleConstructorReturn(
        this,
        (_ref =
          DanteTooltipItem.__proto__ ||
          Object.getPrototypeOf(DanteTooltipItem)).call.apply(
          _ref,
          [this].concat(args)
        )
      );
      ...
      _defineProperty(
        ...
        function() {
          if (
            !_this2.props.editorState ||
            !_this2.props.editorState.getCurrentContent().hasText()
          ) {
            return;
          }
      ...
      _defineProperty(
        ...
        function() {
          ...
          var blockKey = _this2.props.editorState
            .getCurrentContent()
  ...
  (function(_React$Component3) {
    ...
    function DanteTooltipLink() {
      ...
      _this3 = _possibleConstructorReturn(
        this,
        (_ref2 =
          DanteTooltipLink.__proto__ ||
          Object.getPrototypeOf(DanteTooltipLink)).call.apply(
          _ref2,
          [this].concat(args)
        )
      );

      _defineProperty(_assertThisInitialized(_this3), "promptForLink", function(
        ev
      ) {
      ...
      _this3.promptForLink = _this3.promptForLink.bind(
...
var DanteTooltipConfig = function DanteTooltipConfig(isMini = false) {
  var options =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var config = {
    ref: "insert_tooltip",
...
var ImageBlock =
  ...
  (function(_React$Component) {
    ...
    function ImageBlock(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (ImageBlock.__proto__ || Object.getPrototypeOf(ImageBlock)).call(
          this,
          props
        )
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "defaultUrl", function(
        data
      ) {
        if (data.url) {
          return data.url;
      ...
      _defineProperty(_assertThisInitialized(_this), "getAspectRatio", function(
        w,
        h
      ) {
        var maxWidth = 1000;
      ...
      _defineProperty(_assertThisInitialized(_this), "updateData", function() {
        ...
        return setEditorState(
          updateDataOfBlock(getEditorState(), block, newData)
        );
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "replaceImg", function() {
        ...
        if (
          !_this.img.src.includes("blob:") &&
          !_this.props.block.data.get("forceUpload")
        ) {
          return;
        }
      ...
      _defineProperty(
        ...
        function() {
          ...
          var newselection = getEditorState()
            .getSelection()
            .merge({
          ...
          return setEditorState(
            draftJs.EditorState.forceSelection(getEditorState(), newselection)
          );
        }
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "getBase64Image", function(
        img
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), "uploadFile", function() {
        ...
        if (_this.config.upload_handler) {
          return _this.config.upload_handler(
            _this.formatData().get("file"),
            _assertThisInitialized(_this)
          );
        }
        ...
        axios({
          ...
          .then(function(result) {
            ...
            if (_this.config.upload_callback) {
              return _this.config.upload_callback(
                result,
                _assertThisInitialized(_this)
              );
            }
          ...
          .catch(function(error) {
            ...
            if (_this.config.upload_error_callback) {
              return _this.config.upload_error_callback(
                error,
                _assertThisInitialized(_this)
              );
            }
      ...
      _defineProperty(
        ...
        function() {
          return (
            _this.config.image_caption_placeholder || "caption here (optional)"
          );
        }
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "render", function() {
        return React.createElement(
          ...
          React.createElement(
            ...
            _this.props.block.getText().length === 0
              ? React.createElement(
                  "span",
                  {
...
var Loader =
  ...
  (function(_React$Component2) {
    ...
    function Loader() {
      ...
      _this2 = _possibleConstructorReturn(
        this,
        (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(
          _ref,
          [this].concat(args)
        )
      );
                ...
                React.createElement(
                  ...
                  _this2.props.progress === 100
                    ...
                    : React.createElement(
                        ...
                        " ",
                        Math.round(_this2.props.progress)
                      )
                )
              )
            : undefined
...
var EmbedBlock =
  ...
  (function(_React$Component) {
    ...
    function EmbedBlock(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (EmbedBlock.__proto__ || Object.getPrototypeOf(EmbedBlock)).call(
          this,
          props
        )
      );
      ...
      _defineProperty(_assertThisInitialized(_this), "picture", function() {
        if (
          _this.state.embed_data.images &&
          _this.state.embed_data.images.length > 0
        ) {
    ...
    _createClass(EmbedBlock, [
      {
        ...
        value: function componentDidMount() {
          ...
          return axios({
            method: "get",
            url: ""
              .concat(this.dataForUpdate().endpoint)
              .concat(this.dataForUpdate().provisory_text, "&scheme=https")
          })
            .then(function(result) {
...
var VideoBlock =
  ...
  (function(_React$Component) {
    ...
    function VideoBlock(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (VideoBlock.__proto__ || Object.getPrototypeOf(VideoBlock)).call(
          this,
          props
        )
      );
      ...
      _defineProperty(
        ...
        function() {
          if (_this.dataForUpdate().mediaRenderHandler) {
            ...
            return _this.state.embed_data.media
              ? _this.state.embed_data.media.html
              : _this.state.embed_data.html;
          }
        }
      );
  ...
  (function(_React$Component) {
    ...
    function PlaceholderBlock(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (
          PlaceholderBlock.__proto__ || Object.getPrototypeOf(PlaceholderBlock)
        ).call(this, props)
      );
      ...
      _defineProperty(
        ...
        function() {
          ...
          //}
          return (
            _this.props.blockProps.data.toJS().placeholder ||
            _this.placeholderFromProps() ||
            _this.defaultText()
          );
        }
      );
...
var DividerBlock =
  ...
  (function(_React$Component) {
    ...
    function DividerBlock(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (DividerBlock.__proto__ || Object.getPrototypeOf(DividerBlock)).call(
          this,
          props
        )
      );
...
var Dante =
  ...
  (function(_React$Component) {
    ...
    function Dante(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (Dante.__proto__ || Object.getPrototypeOf(Dante)).call(this, props)
      );
...
var DanteMini =
  /*#__PURE__*/
  (function(_React$Component) {
    _inherits(DanteMini, _React$Component);

    function DanteMini(props) {
      var _this;

      _classCallCheck(this, DanteMini);

      _this = _possibleConstructorReturn(
        this,
        (DanteMini.__proto__ || Object.getPrototypeOf(DanteMini)).call(
          this,
          props
        )
      );
...
DanteMini.defaultProps = {
  content: null,
  read_only: false,
  spellcheck: false,
  title_placeholder: "Tiêu đề",
  body_placeholder: "Nhấn enter để gửi",
  xhr: {
    before_handler: null,
    success_handler: null,
    error_handler: null
...
module.exports = { Dante: Dante, DanteMini: DanteMini };
